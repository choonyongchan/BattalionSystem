...
export const dutyRules = {
  isEligible(dt: string, soldier: Soldier, nameOverrides: Record<string, string[]>, rankRuleOverrides: Record<string, { from: string; to: string }>): boolean {
  ...
  eligibleSoldiers(dt: string, soldiers: Soldier[], nameOverrides: Record<string, string[]>, rankRuleOverrides: Record<string, { from: string; to: string }>): Soldier[] {
